...
app.post("/orderForm",(req, res) => {
  ...
  con.query("INSERT INTO `bshop`.`orders` (`orderDate`, `orderTime`, `mobNumber`, `product`, `customerName`,`qty`) VALUES ('"+date+"','"+time+"','"+sess.number+"','"+productName+"','"+name+"',"+qty+");",function(err,res1){
    if(!err){
